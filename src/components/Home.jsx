  ...
  return (
    <div className="h-[100%] w-full py-8 flex flex-col  overflow-y-scroll no-scrollbar">
      ...
      <div className="flex xs:flex-col md:flex-row h-[1000px] py-5 my-5 w-full  xs:overflow-y-scroll xs:no-scrollbar md:overflow-y-hidden">
        ...
        <Link to = '/services' className="flex flex-col items-center py-2 xs:w-[90%] md:w-[300px] h-[300px] bg-white border rounded-lg shadow-lg mx-auto my-2">
          <img
            src={ServiceLogo}
            className="w-[90%] h-[80%] rounded-lg"
            alt="house keeping"
        ...
        <Link to = '/info' className="flex flex-col items-center py-2 xs:w-[90%] md:w-[300px] h-[300px] bg-white border rounded-lg shadow-lg mx-auto my-2">
          <img
            src={InfoLogo}
            className="w-[90%] h-[80%] rounded-lg"
            alt="need help"
