...
const Info = () => {
  return (
    ...
    <div className="flex flex-col h-[1000px] py-5 my-2 w-full">
      ...
      >
        ...
        <span className='text-xl font-normal my-2'>Thank you for booking with us. We hope you have a wonderful stay!</span>
        <h3 className="text-2xl font-bold my-2 ">Important Information:</h3>
        <h3 className="text-2xl font-bold my-2 ">Wifi Password: <span className='text-2xl font-normal my-2'>00000</span></h3>
        <h3 className="text-2xl font-bold my-2 ">Phone Numbers:
            <ul className='pl-5'>
                <li className='text-2xl font-normal my-2' >Owner: 00000</li>
                <li className='text-2xl font-normal my-2' >Guard: 0000</li>
                <li className='text-2xl font-normal my-2' >Laundry Room (1st Floor, Room 110)</li>
            </ul>
        </h3>
        <h3 className="text-2xl font-bold my-2 ">
            Services Note: <span className='text-2xl font-normal my-2'>Cleaning requires at least 1 hour and must be requested in</span>
            <span className='text-2xl font-normal my-2'>advance.</span>
        </h3>
        <h3 className="text-2xl font-bold my-2 ">
            Tour Guide: <span className='text-2xl font-normal my-2'>Please book in advance; up to 4 people per tour.</span>
        </h3>
        <h3 className="text-2xl font-bold my-2 ">
            Food Delivery: <span className='text-2xl font-normal my-2'>Requires at least 1 hour for delivery</span>
        </h3>
      </div>
    </div>
